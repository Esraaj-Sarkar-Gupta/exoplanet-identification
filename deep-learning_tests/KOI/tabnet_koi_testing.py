...
# ---- Features Sets ---- #
# ... (rest of your code continues here exactly as before)
# ---- Features Sets ---- #
features_driven = [
...
def main():
    ...
    print(f"Loading KOI data from: {data_path.name}...")
    ...
    for set_name, features in feature_dict.items():
        ...
        X = df_engineered[features].values # TabNet requires numpy arrays
        y = df_engineered["Target"].astype(int).values # TabNet requires integer labels
